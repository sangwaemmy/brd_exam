...
function Banner() {
    ...
    const txtChanger = () => {
        if (countResetabble == 1) {
            setTxtDisplay("Procurement Management with ease")
        } else if (countResetabble == 2) {
            setTxtDisplay("Tender Management with ease")
        } else if (countResetabble == 3) {
            setTxtDisplay("Procure and tender")
        } else if (countResetabble == 4) {
            setTxtDisplay("Bid and Bidders control")

        } else if (countResetabble == 5) {
            setTxtDisplay("Track bids")
        } else if (countResetabble == 6) {
            setTxtDisplay("Manage, Track, control Bids")
        }
    }
